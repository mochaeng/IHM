...
func _ready():
	...
	worlds[2].get_node("Logo").frame = 3
	...
	worlds[2].get_node("PlayButton").connect("pressed", _on_world3_play_button_pressed)
...
func _on_world3_play_button_pressed():
	Utils.change_scene_with_transition("Phases_3_Selection")
